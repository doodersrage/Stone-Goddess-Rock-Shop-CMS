...
if($this->ratio)
{
$thumb = ($this->new_width < $width && $this->new_height < $height) ? true : true; // Thumbnail
$bigger_image = ($this->new_width > $width || $this->new_height > $height) ? false : false; // Bigger Image
